...
public class PreprocessActivity extends BaseActivity<PreprocessContract.Presenter> implements PreprocessContract.View {
    ...
    private void initPresenter() {
        preprocessAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (databean != null) {
                    PreprocessDetilsActivity.start(PreprocessActivity.this, position, databean);
                }
            }
        });
    ...
    public Toolbar initToolbar(String title) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(PreprocessActivity.this, ExamineActivity.class));
                finish();
            }
        });
    ...
    @Override
    public void setPreprocessData(List<Preprocess.DataBean> data, int total, int pagNum) {
