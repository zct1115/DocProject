...
public interface PreprocessStoreroomContract {
    interface View{
         /*
        * 成功获取数据，设置数据到适配器
        * */
         void setPreprocessStoreroomData(List<Preprocess.DataBean> data, int total, int pageNum);

        /*
      * 获取预归数据失败
      * */
        void getPreprocessStoreroomDataFail(String message);
