...
public class Time{
    ...
    private int scrollUnits = org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.HOUR.value + org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.MINUTE.value;
    ...
    public Time(Context context,ResultHandler resultHandler, String startDate, String endDate) {
    ...
    public Time(Context context,ResultHandler resultHandler, String startDate, String endDate, String workStartTime, String workEndTime) {
    ...
    private void initTimer() {
        ...
        if (spanYear) {
            ...
            if ((scrollUnits & org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.HOUR.value) != org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.HOUR.value) {
            ...
            if ((scrollUnits & org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.MINUTE.value) != org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.MINUTE.value) {
    ...
    private void excuteScroll() {
        ...
        hour_pv.setCanScroll(hour.size() > 1 && (scrollUnits & org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.HOUR.value) == org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.HOUR.value);
        minute_pv.setCanScroll(minute.size() > 1 && (scrollUnits & org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.MINUTE.value) == org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.MINUTE.value);
    }
    ...
    public int disScrollUnit(org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE... scrolltypes) {
        if (scrolltypes == null || scrolltypes.length == 0)
            scrollUnits = org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.HOUR.value + org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.MINUTE.value;
        for (org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE scrolltype : scrolltypes) {
            scrollUnits ^= scrolltype.value;
        }
        return scrollUnits;
    }

    public void setMode(org.feezu.liuli.timeselector.TimeSelector.MODE mode) {
        switch (mode.value) {
            case 1:
                disScrollUnit(org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.HOUR, org.feezu.liuli.timeselector.TimeSelector.SCROLLTYPE.MINUTE);
